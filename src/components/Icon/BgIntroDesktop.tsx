...
const SvgBgIntroDesktop = (
  ...
  >
    ...
    <g fill="none" fillRule="evenodd" transform="translate(15)">
      <use
        fill="#000"
        filter="url(#bg-intro-desktop_svg__a)"
        xlinkHref="#bg-intro-desktop_svg__b"
      />
      <use fill="#2D314D" xlinkHref="#bg-intro-desktop_svg__b" />
      <path
        fill="url(#bg-intro-desktop_svg__c)"
...
const ForwardRef = forwardRef(SvgBgIntroDesktop);
