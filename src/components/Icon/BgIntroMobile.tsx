...
const SvgBgIntroMobile = (
  ...
  >
    ...
    <g fill="none" fillRule="evenodd" transform="translate(-94 -52)">
      <use
        fill="#000"
        filter="url(#bg-intro-mobile_svg__a)"
        xlinkHref="#bg-intro-mobile_svg__b"
      />
      <use fill="#2D314D" xlinkHref="#bg-intro-mobile_svg__b" />
      <path
        fill="url(#bg-intro-mobile_svg__c)"
...
const ForwardRef = forwardRef(SvgBgIntroMobile);
